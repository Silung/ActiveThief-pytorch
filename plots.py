...
if mode == 'bar':
    ...
    plt.plot(x1,y1,label='Normal',color='#E49AAB',zorder=1)
    plt.plot(x2,y2,label='ActiveThief',color='#FFDFA2',zorder=2)
    plt.plot(x3,y3,label='TransferThief',color='#BFE4FF',zorder=3)
...
plt.title(f'MEA agr on {dataset}')
